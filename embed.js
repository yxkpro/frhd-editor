...
function xc(n, e) {
  ...
  // If this is a bookmark but NOT Spotify or Bandcamp, stop
  if (bookmark && !t.includes("spotify.com") && !t.includes("bandcamp.com")) {
    return;
  }
  ...
  // Attach resize listener (assuming lc() is a debounce/throttle function)
  window.addEventListener("resize", lc(requestHeight));

  e.appendChild(i);

  // Request initial height after appending
  requestHeight();
}
